			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sdmcoletor-display": {
								"semanticObject": "sdmcoletor",
								"action": "display",
								"description": "SDM Coletor",
								"title": "SDM Coletor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sdmcoletor",
									"url": sap.ui.require.toUrl("sdmcoletor")
								}
							}
						}
					}
